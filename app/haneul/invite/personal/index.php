...
<body >
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand ml-4" href="#">QR - Agregar Personal</a>
                ...
                <div class="modal-body" style="background-color: #e7e7e7">
                    <form action="./endpoint/add-invite.php" method="POST">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <input type="text" class="form-control" id="Equipment" name="Equipment" style="text-transform: capitalize;" value ="N/A" required>
                        </div>
                        <div class="form-group" style="display:none;">
                            <label for="Brand">Marca: <i style="font-size: 0.8rem;">(Ejemplo: DELL, FLUKE, HP, etc.)</i></label>
                            <input type="text" class="form-control" id="Brand" name="Brand" style="text-transform:uppercase" value ="N/A" required>
                        </div>
                        <div class="form-group" style="display:none;">
                            <label for="Serial">Serial: <i style="font-size: 0.8rem;">(Últimos 5 dígitos 7RA7KDM<b>258NK</b>)</i></label>
                            <input type="text" class="form-control" id="Serial" name="Serial" style="text-transform:uppercase" maxlength="5" value ="00000" required>
                        </div>
                        <div class="form-group" style="display:none;">
                            <label for="Status">Estado:</label>
                            <select name="Status" id="Status" class="form-control" required>
                                <!--<option disabled selected value></option>-->
                                <option selected value="Retiro">Ingreso</option>
    ...
    <script>  
        ...
        function generateQrCode() {
            ...
            let text = generateRandomCode(20);
            ...
            if (text === "") {
                ...
                let text1 = document.getElementById("Type_ID").value;
                let text2 = document.getElementById("N_ID").value;
                let text3 = document.getElementById("Company").value;
        ...
        function startTimer(duration, display) {
            ...
            setInterval(function () {
                ...
                if (timer == 0) {
                    window.location = "https://www.servimizer.com/app/haneul/invite/personal/error.php";  
                };
                if (timer == 58) {
