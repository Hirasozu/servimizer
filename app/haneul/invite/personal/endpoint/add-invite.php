...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['user_name'], $_POST['Type_ID'], $_POST['N_ID'], $_POST['N_Phone'], $_POST['Company'], $_POST['email'], $_POST['Area'], $_POST['Equipment'], $_POST['Brand'], $_POST['Serial'], $_POST['Status'])) {
        ...
        try {
            ...
            $stmt->execute();
            header("Location: https://www.servimizer.com/app/haneul/invite/personal/complete.php?i=$generatedCode&e=$Type_ID&b=$N_ID&s=$Company");
        ...
        echo "
            <script>
                ...
                window.location.href = 'https://www.servimizer.com/app/haneul/invite/personal/error.php';
            </script>
        ";
    }
}
