                    ...
                    <table class="table text-center table-sm" id="studentTable" style="width:100%">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" style="display:none;">No. de Celular</th>
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td id="N_Phone-<?= $studentID ?>" style="display:none;"><?= $N_Phone ?></td>
                                    <td id="Company-<?= $studentID ?>" style="display:none;"><?= $Company ?></td>
                                    <td id="email-<?= $studentID ?>" style="display:none;"><?= $email ?></td>
                                    <td id="Area-<?= $studentID ?>"style="text-transform: capitalize;" ><?= $Area ?></td>
                                    <td id="Equipment-<?= $studentID ?>" style="text-transform: capitalize;" ><?= $Equipment ?></td>
                                    <td id="Brand-<?= $studentID ?>" style="text-transform:uppercase"><?= $Brand ?></td>
                                    <td id="Serial-<?= $studentID ?>" style="text-transform:uppercase"><?= $Serial ?></td>
                                    <td>
