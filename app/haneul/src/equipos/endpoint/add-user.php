...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['user_name'], $_POST['Type_ID'], $_POST['N_ID'], $_POST['N_Phone'], $_POST['Company'], $_POST['email'], $_POST['Area'], $_POST['Equipment'], $_POST['Brand'], $_POST['Serial'], $_POST['Status'])) {
        ...
        try {
            ...
            header("Location: https://www.servimizer.com/app/haneul/src/equipos/masterlist.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'https://www.servimizer.com/app/haneul/src/equipos/masterlist.php';
            </script>
        ";
    }
}
